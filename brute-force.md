...
<img src="additions_graph.png" alt="Additions Graph" style="width:70%;">
...
- Συχνά μία ποσότητα που χρειάζεται να υπολογίσουμε για κάποιο διάστημα $(l, r)$ μπορεί να προκύψει εύκολα συνδιάζοντας τα αποτελέσματα του εθυλακωμένου διαστήματος $(l, r-1)$ με την νέα τιμή $a[r]$
