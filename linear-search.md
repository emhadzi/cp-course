...
Αντίστοιχα μπορούμε να απαντήσουμε για το γινόμενο, ΜΚΔ και άλλες πράξεις που ικανοποιούν συγκεκριμένες ιδιότητες 
> Μπορείτε να σχολιάσετε κάποιες από αυτές τις ιδιότητες?
...
*Αν το νέο στοιχείο είναι (πρώτο) ελάχιστο, τότε δεύτερο ελάχιστο θα είναι πλέον το προηγούμενο (πρώτο) ελάχιστο*
...
Μας δίνεται ένας `n x m` πίνακας `grid` που αναπαριστά έναν χάρτη. 